        ...
        <article>
          <div className="content_articles_container">
            <p className="content_articles_item">
              Somos uma empresa de inteligência tributária, com objetivo de
              trazer aos nossos parceiros resultados eficientes e ser referência
              em todo Brasil.
            </p>
            <p className="content_articles_item">
            ...
            <p className="content_articles_item">
              Trabalhamos para identificar e criar soluções legais de
              recuperação de créditos e soluções eficientes para redução de
              custos tributários.
            </p>
          </div>
          <div className="business_div_img">
            <img
              src="./src/assets/whoAreWe.jpg"
              alt="Business"
